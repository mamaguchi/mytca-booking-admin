...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/clinicadmin/actions.js'), 'clinicadmin/actions.js')
  resolveStoreModules(require('../store/clinicadmin/getters.js'), 'clinicadmin/getters.js')
  resolveStoreModules(require('../store/clinicadmin/mutations.js'), 'clinicadmin/mutations.js')
  resolveStoreModules(require('../store/clinicadmin/state.js'), 'clinicadmin/state.js')
  ...
  if (process.client && module.hot) {
    ...
    module.hot.accept([
      ...
      '../store/auth/state.js',
      '../store/clinicadmin/actions.js',
      '../store/clinicadmin/getters.js',
      '../store/clinicadmin/mutations.js',
      '../store/clinicadmin/state.js',
    ], () => {
